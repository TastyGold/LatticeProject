...
namespace LatticeProject.Rendering
{
    internal static class GameItemRenderer
    {
        ...
        private static readonly int itemResolution = 10;

        public static void Initialise()
        {
            itemAtlas = Raylib.LoadTexture("..//..//..//Assets/9-tone-items.png");
        }
        ...
        {
            Rectangle srec = new (item.color * itemResolution, 0, itemResolution, itemResolution);
